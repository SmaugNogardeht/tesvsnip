...
namespace TESVSnip
{
  ...
  internal partial class MainView : Form
  {
    ...
    private TranslatorHelper translatorHelperContent = new TranslatorHelper();
    ...
    public MainView()
    {
      ...
      InitializeToolStripTranslatorHelper(); //Add for TranslatorHelper
    ...
    private void InitializeLanguage()
    {
      ...
      languageToolBarItems.Add("Japanese", japaneseToolStripMenuItem);
    }
    ...
    private void LayoutDockingWindows(bool force)
    {
      try
      {
        if (!force
            ...
            && IsVisible(translatorHelperContent)) //Add for TranslatorHelper
          return;
    ...
    private void ShowDockingWindows()
    {
      ...
      //Add for TranslatorHelper
      this.translatorHelperContent.MdiParent = this;
      this.translatorHelperContent.CloseButtonVisible = false;
      this.translatorHelperContent.CloseButton = false;
      this.translatorHelperContent.HideOnClose = true;
      //End for TranslatorHelper
    ...
    private IDockContent GetContentFromPersistString(string persistString)
    {
      ...
      //Add for TranslatorHelper
      if (persistString == typeof(TranslatorHelper).ToString())
        return translatorHelperContent;
      //End for TranslatorHelper
